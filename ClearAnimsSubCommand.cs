...
namespace SCPCanvasPaint.Commands
{
    public class ClearAnimsSubCommand : ICommand
    {
        ...
        public string Description => "Удалить абсолютно все холсты с GIF-анимациями на карте";
        ...
        public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
        {
            ...
            {
                response = "Только администраторы могут массово удалять анимации!";
                return false;
            }
            ...
            {
                response = "На карте не найдено активных GIF-анимаций.";
                return true;
            }
            ...
            response = $"Успешно удалено холстов с анимациями: {count} шт.";
            return true;
        }
    }
}
